                            ...
                            if (managers.Game.multi) {
                                ...
                                if (this.name == "P2") {
                                    if ((managers.Game.keyboardManager.P2shoot) && (ticker % 10 == 0)) {
                                        this.bulletSpawn = new math.Vec2(this.x - 15.35, this.y - 40);
                                        this.effect = new objects.Effect("Laser_Shoot", this.x - 13, this.y - 43);
                                        var bullet = managers.Game.P2BulletManager.GetBullet();
                                        //console.log(bullet);
                                        bullet.x = this.bulletSpawn.x;
                                        bullet.y = this.bulletSpawn.y;
                                        var laser = createjs.Sound.play("laser");
                            ...
                            if (managers.Game.multi) {
                                if (this.name == "P1") {
                                    if ((managers.Game.keyboardManager.P1shoot) && (ticker % 10 == 0)) {
                                        this.bulletSpawn = new math.Vec2(this.x - 15.35, this.y - 25);
                                        this.effect = new objects.Effect("Laser_Shoot", this.x - 13, this.y - 43);
                                        var ammo = managers.Game.P1BulletManager.GetBullet();
                                        ammo.x = this.bulletSpawn.x;
                                        ammo.y = this.bulletSpawn.y;
                                        var laser = createjs.Sound.play("laser");
                                        laser.volume = 0.1;
                                ...
                                if (this.name == "P2") {
                                    if ((managers.Game.keyboardManager.P2shoot) && (ticker % 10 == 0)) {
                                        this.bulletSpawn = new math.Vec2(this.x - 15.35, this.y - 25);
                                        this.effect = new objects.Effect("Laser_Shoot", this.x - 13, this.y - 43);
                                        var ammo = managers.Game.P2BulletManager.GetBullet();
                                        ammo.x = this.bulletSpawn.x;
                                        ammo.y = this.bulletSpawn.y;
                                        var laser = createjs.Sound.play("laser");
                                        laser.volume = 0.1;
                            ...
                            if (managers.Game.multi) {
                                if (this.name == "P1") {
                                    if ((managers.Game.keyboardManager.P1shoot) && (ticker % 10 == 0)) {
                                        ...
                                        this.effect = new objects.Effect("Laser1_Shoot", this.x - 13, this.y - 43);
                                        var ammo = managers.Game.P1BulletManager.GetBullet();
                                        var ammo2 = managers.Game.P1BulletManager.GetBullet();
                                        ammo.x = this.bulletSpawn.x;
                                        ammo.y = this.bulletSpawn.y;
                                        ammo2.x = this.x - 11;
                                        ammo2.y = this.bulletSpawn.y;
                                ...
                                if (this.name == "P2") {
                                    if ((managers.Game.keyboardManager.P2shoot) && (ticker % 10 == 0)) {
                                        ...
                                        this.effect = new objects.Effect("Laser1_Shoot", this.x - 13, this.y - 43);
                                        var ammo = managers.Game.P2BulletManager.GetBullet();
                                        var ammo2 = managers.Game.P2BulletManager.GetBullet();
                                        ammo.x = this.bulletSpawn.x;
                                        ammo.y = this.bulletSpawn.y;
                                        ammo2.x = this.x - 11;
                                        ammo2.y = this.bulletSpawn.y;
                            ...
                            if (managers.Game.multi) {
                                if (this.name == "P1") {
                                    if ((managers.Game.keyboardManager.P1shoot) && (ticker % 10 == 0)) {
                                        ...
                                        var ammo = managers.Game.P1BulletManager.GetBullet();
                                        var ammo2 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo3 = managers.Game.P1BulletManager.GetBullet();
                                        ammo.x = this.x - 11;
                                        ammo.y = this.y - 25;
                                        // Right
                                        ammo2.x = this.x - 11;
                                ...
                                if (this.name == "P2") {
                                    if ((managers.Game.keyboardManager.P2shoot) && (ticker % 10 == 0)) {
                                        ...
                                        var ammo = managers.Game.P2BulletManager.GetBullet();
                                        var ammo2 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo3 = managers.Game.P2BulletManager.GetBullet();
                                        ammo.x = this.x - 11;
                                        ammo.y = this.y - 25;
                                        // Right
                                        ammo2.x = this.x - 11;
                            ...
                            if (managers.Game.multi) {
                                if (this.name == "P1") {
                                    if ((managers.Game.keyboardManager.P1shoot) && (ticker % 10 == 0)) {
                                        ...
                                        var ammo2 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo3 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo4 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo5 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo6 = managers.Game.P1BulletManager.GetBullet();
                                        ammo.x = this.x - 14;
                                        ammo.y = this.y - 25;
                                        ammo2.x = this.x - 7;
                                        ammo2.y = this.y - 25;
                                ...
                                if (this.name == "P2") {
                                    if ((managers.Game.keyboardManager.P2shoot) && (ticker % 10 == 0)) {
                                        ...
                                        var ammo2 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo3 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo4 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo5 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo6 = managers.Game.P2BulletManager.GetBullet();
                                        ammo.x = this.x - 14;
                                        ammo.y = this.y - 25;
                                        ammo2.x = this.x - 7;
                                        ammo2.y = this.y - 25;
                            ...
                            if (managers.Game.multi) {
                                if (this.name == "P1") {
                                    if ((managers.Game.keyboardManager.P1shoot) && (ticker % 10 == 0)) {
                                        ...
                                        var ammo5 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo6 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo7 = managers.Game.P1BulletManager.GetBullet();
                                        var ammo8 = managers.Game.P1BulletManager.GetBullet();
                                        ammo.x = this.x - 14;
                                        ammo.y = this.y - 25;
                                        ammo2.x = this.x - 7;
                                        ammo2.y = this.y - 25;
                                ...
                                if (this.name == "P2") {
                                    if ((managers.Game.keyboardManager.P2shoot) && (ticker % 10 == 0)) {
                                        ...
                                        var ammo5 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo6 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo7 = managers.Game.P2BulletManager.GetBullet();
                                        var ammo8 = managers.Game.P2BulletManager.GetBullet();
                                        ammo.x = this.x - 14;
                                        ammo.y = this.y - 25;
                                        ammo2.x = this.x - 7;
                                        ammo2.y = this.y - 25;
