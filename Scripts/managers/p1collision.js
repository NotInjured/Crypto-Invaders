var managers;
(function (managers) {
    var P1Collision = /** @class */ (function () {
        function P1Collision() {
        }
        // Check collisions using AABB (Axis-aligned Bounding Box)
        P1Collision.CheckAABB = function (object1, object2) {
            ...
            switch (object2.name) {
                ...
                case "Enemy12":
                    if ((object1.x + object1.halfW) > ((object2.x - 10) - object2.halfW) &&
                        ...
                        (object1.y - object1.halfH) < ((object2.y - 10) + object2.halfH)) {
                        managers.Game.hud.P1Score += 50 * managers.Game.hud.P1ScoreMult;
                        ...
                        if (managers.Game.P1.ShipType == config.Ship.Botcoin)
                            effect = new objects.Effect("Laser_Hit", object1.x + 10, object1.y - object1.halfH);
                        else if (managers.Game.P1.ShipType == config.Ship.Lightcoin)
                ...
                case "Enemy5":
                    if ((object1.x + object1.halfW) > ((object2.x - 10) - object2.halfW) &&
                        ...
                        if (managers.Game.eEliteHp == 0 || (managers.Game.eEliteHp < 0 && Math.abs(managers.Game.eEliteHp) % 25 == 0)) {
                            ...
                            managers.Game.hud.P1ScoreMult += 10;
                            managers.Game.hud.P1Score += 25000 * managers.Game.hud.P1ScoreMult;
                        }
                    }
                    break;
                case "Enemy6":
                    if ((object1.x + object1.halfW) > ((object2.x - 10) - object2.halfW) &&
                        ...
                        if (managers.Game.eMinionHp == 0 || (managers.Game.eMinionHp < 0 && Math.abs(managers.Game.eMinionHp) % 10 == 0)) {
                            ...
                            object2.Reset();
                            managers.Game.currentSceneObject.removeChild(object2);
                            managers.Game.hud.P1ScoreMult += 5;
                            managers.Game.hud.P1Score += Math.round(1250 * Math.pow(1.05, managers.Game.hud.P1ScoreMult));
                        }
                    }
                    break;
                case "Destroyer":
    ...
    managers.P1Collision = P1Collision;
})(managers || (managers = {}));
//# sourceMappingURL=p1collision.js.map